...
import com.born.test.Constants;
public class TestReportUtil {
	...
	try	{
		...
		out.write("<html><HEAD> <TITLE>BEATS TEST RESULTS</TITLE></HEAD><body><style><!--body {background-image: url("+ watermark +");background-repeat: no-repeat; background-color: rgb(216, 227, 186);width: 900px;background-position: 196px 113px; } //--></style> <h4 align=center><FONT COLOR=#000000 FACE=AriaL SIZE=6><b><u> BEATS TEST RESULTS</u></b></h4><table  border=1 cellspacing=1 cellpadding=1 ><tr><h4> <FONT COLOR=660000 FACE=Arial SIZE=4.5> "+project+" Test Details :</h4><td width=150 align=left bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75><b>Run Date</b></td><td width=150 align=left><FONT COLOR=#153E7E FACE=Arial SIZE=2.75><b>");
		...
		out.write(release);
		out.write("</b></td></tr><tr><td width=150 align= left  bgcolor=#153e7e><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2.75><b>Browser Type</b></td><td width=150 align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2.75><b>");
		out.write(browser);
		...
		out.write("</table></br>");
		out.write("<h4> <FONT COLOR=660000 FACE= Arial  SIZE=4.5> "+ project +" Execution Results </h4>");
		out.write("<table  border=1 cellspacing=1 cellpadding=1>");
		out.write("<tr><td width=150 align=left bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75><b>Total Suites</b></td><td width=150 align=left><FONT COLOR=#153E7E FACE=Arial SIZE=2.75><b>");
		Integer suitCount = totalTestSuites - 1;
		out.write(suitCount.toString());
		System.out.println("Total Suites  ------>>"+suitCount );
		out.write("</b></td></tr><tr><td width=150 align=left bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75><b>Total Test Scenarios</b></td><td width=150 align=left><FONT COLOR=#153E7E FACE=Arial SIZE=2.75><b>");
		...
		out.write("</b></td></tr><tr><td width=150 align=left bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75><b>Total Test Steps</b></td><td width=150 align=left><FONT COLOR=#153E7E FACE=Arial SIZE=2.75><b>");
